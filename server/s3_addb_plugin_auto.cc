...
int s3_addb_init() {
  ...
  gs_addb_map[std::type_index(typeid(S3DeleteBucketReplicationAction))] =
  ...
  gs_addb_map[std::type_index(typeid(S3GetAuditLogSchemaAction))] =
  ...
  gs_addb_map[std::type_index(typeid(S3GetBucketReplicationAction))] =
  ...
  gs_addb_map[std::type_index(typeid(S3PutBucketReplicationAction))] =
  ...
  s3_log(S3_LOG_DEBUG, "",
         "  * id 0x%" PRIx64 "/%" PRId64  // suppress clang warning
         ": class S3DeleteBucketReplicationAction\n",
         (uint64_t)S3_ADDB_S3_DELETE_BUCKET_REPLICATION_ACTION_ID,
         (int64_t)S3_ADDB_S3_DELETE_BUCKET_REPLICATION_ACTION_ID);
  ...
  s3_log(S3_LOG_DEBUG, "",
         "  * id 0x%" PRIx64 "/%" PRId64  // suppress clang warning
         ": class S3GetAuditLogSchemaAction\n",
         (uint64_t)S3_ADDB_S3_GET_AUDIT_LOG_SCHEMA_ACTION_ID,
         (int64_t)S3_ADDB_S3_GET_AUDIT_LOG_SCHEMA_ACTION_ID);
  ...
  s3_log(S3_LOG_DEBUG, "",
         "  * id 0x%" PRIx64 "/%" PRId64  // suppress clang warning
         ": class S3GetBucketReplicationAction\n",
         (uint64_t)S3_ADDB_S3_GET_BUCKET_REPLICATION_ACTION_ID,
         (int64_t)S3_ADDB_S3_GET_BUCKET_REPLICATION_ACTION_ID);
  ...
  s3_log(S3_LOG_DEBUG, "",
         "  * id 0x%" PRIx64 "/%" PRId64  // suppress clang warning
         ": class S3PutBucketReplicationAction\n",
         (uint64_t)S3_ADDB_S3_PUT_BUCKET_REPLICATION_ACTION_ID,
         (int64_t)S3_ADDB_S3_PUT_BUCKET_REPLICATION_ACTION_ID);
